        ...
        if old_count_activities < len(activity_df_list):
            for challenge in challenges:
                if user in challenge.participants.all():
                    ...
                    existing_activities = challenge.activities.filter(
                        athlete=user, sport_type=challenge.sport_type)
                    new_activities = Activity.objects.filter(
                        athlete=user, sport_type=challenge.sport_type).exclude(id__in=existing_activities)
